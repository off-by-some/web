import{n as b,a as m,f as n,c as a,p as z,b as P,s as i,d as $}from"./iframe-fOSp1g-8.js";import{c as C,i as G,d as w}from"./create-runtime-stories-iiAF5L6N.js";import{I as e}from"./Image-BzOQH6Vn.js";import{a as x}from"./design-notes-CQ-o3Wt1.js";import{h as D}from"./controls-B7FSozl-.js";import"./preload-helper-k3ZeA0S-.js";import"./each-AfYBugIQ.js";import"./attributes-CNetG9VL.js";import"./this-CdFe53gN.js";import"./paths-a1BFJcfT.js";const F=(t,o=b)=>{var s=j(),r=a(s);e(r,{get src(){return o().src},alt:"Portrait example",sizes:"12rem",priority:!0}),m(t,s)},S={title:"Library/Primitives/Media/Image",component:e,render:F,tags:["autodocs"],args:{src:"headshot.png"},argTypes:{...D(["alt","sizes","loading","decoding","fetchpriority","priority","width","height"]),src:{control:"text"}},parameters:{docs:{description:{component:x.image}}}},{Story:l}=w();var j=n('<div class="story-image story-image--portrait svelte-1acgug7"><!></div>'),q=n('<div class="story-grid svelte-1acgug7"><div class="story-image svelte-1acgug7"><!></div> <div class="story-image svelte-1acgug7"><!></div> <div class="story-image svelte-1acgug7"><!></div></div>'),J=n("<!> <!>",1);function v(t,o){z(o,!1),G();var s=J(),r=P(s);l(r,{name:"Default",parameters:{__svelteCsf:{rawCode:`<div class="story-image story-image--portrait">
...
</div>`}}}),m(t,s),$()}v.__docgen={data:[],name:"Image.stories.svelte"};const p=C(v,S),B=["Default","ImageFormats"],H={...p.Default,tags:["svelte-csf-v5"]},K={...p.ImageFormats,tags:["svelte-csf-v5"]};export{H as Default,K as ImageFormats,B as __namedExportsOrder,S as default};
