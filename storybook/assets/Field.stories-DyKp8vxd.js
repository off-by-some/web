import{n as h,b as c,f as g,h as i,i as d,c as _,p as b,d as x,s as u,e as y}from"./iframe-CizSZPhs.js";import{c as w,d as C}from"./create-runtime-stories-qZGdqjtD.js";import{F as p}from"./Field-pmZPDoZW.js";import{I as q}from"./Input-9SXKsDIB.js";import{d as F}from"./design-notes-CQ-o3Wt1.js";import{h as $}from"./controls-B7FSozl-.js";import{i as E}from"./lifecycle-CZYbCPQ5.js";import"./preload-helper-k3ZeA0S-.js";import"./attributes-CfgYz-0Q.js";import"./class-BdT285uw.js";import"./this-B5pmUPfd.js";const I=(o,e=h)=>{var r=k(),a=_(r);p(a,{get id(){return e().id},get label(){return e().label},get required(){return e().required},get error(){return e().error},get counter(){return e().counter},children:(t,l)=>{{let v=d(()=>!!e().error),f=d(()=>e().as==="textarea"?e().rows:void 0);q(t,{get as(){return e().as},get id(){return e().id},get value(){return e().value},get placeholder(){return e().placeholder},get error(){return i(v)},get rows(){return i(f)}})}},$$slots:{default:!0}}),c(o,r)},W={title:"Component Library/Primitives/Forms/Field",component:p,render:I,tags:["autodocs"],args:{id:"story-field",label:"Name",required:!0,error:"",value:"Cassidy Bridges",placeholder:"Your full name",counter:"",as:"input",rows:4},argTypes:{...$(["id","errorId","counterId","counterAriaLabel"]),as:{control:"select",options:["input","textarea"]},label:{control:"text"},required:{control:"boolean"},error:{control:"text"},value:{control:"text"},placeholder:{control:"text"},counter:{control:"text"},rows:{control:{type:"number",min:1,max:12}}},parameters:{docs:{description:{component:`Keeps label, required marker, error text, and character counter attached to one control, so a validation error always has an obvious anchor instead of floating text somewhere else on the page. Reference: [W3C cognitive accessibility guidance](${F.cognitive}).`}}}},{Story:s}=C();var k=g('<div class="story-stack svelte-ldxdfp"><!></div>'),B=g("<!> <!> <!>",1);function m(o,e){b(e,!1),E();var r=B(),a=x(r);s(a,{name:"Default",parameters:{__svelteCsf:{rawCode:`<div class="story-stack">
  <Field
    id={args.id}
    label={args.label}
