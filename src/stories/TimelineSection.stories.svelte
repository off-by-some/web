  ...
  const defaultExperiences = [
    {
      ...
      location: 'Remote',
      summary:
        'Drove major performance optimizations (CPU spikes 99% to 15%, 83% memory reduction), led critical refactoring efforts, and built AI-powered developer tools to boost stability and velocity.',
      highlights: [
    ...
    },
    {
      ...
      location: 'Remote',
      summary:
        'Architected distributed systems achieving 99.9% uptime during 400% traffic surges, built foundational React products saving clients 40+ hrs/week, and pioneered Kubernetes environments accelerating testing by 80%.',
      highlights: [
    ...
    },
    {
      ...
      summary:
        'Engineered a feature-complete spreadsheet interface saving users hundreds of hours. Led Angular-to-React migration improving load times by 60%.',
      highlights: [
    ...
    },
    {
      ...
      summary:
        'Spearheaded Angular 1 to React migration, eliminating 20K+ lines of tech debt. Cut end-to-end test suite execution time by 6 hours.',
      highlights: [
    ...
    },
    {
      ...
      summary:
        'Led full-stack development driving $1.2M+ annual revenue. Served as interim CTO, improving collaboration and aligning technical strategy with business goals.',
      highlights: [
